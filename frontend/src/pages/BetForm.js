...
export default function BetForm({ game, gameType, wallet, onSubmit }) {
  ...
  return (
    <div className="bf-wrap">
      ...
      <style>{`
       .bf-wrap { background: #f5f0e8; min-height: 100vh; padding-bottom: 80px; }
        .bf-banner {
          background: #1a1a2e;
          padding: 14px 16px;
          display: flex; align-items: center; gap: 12px;
          border-bottom: 1.5px solid rgba(232,101,10,0.3);
        ...
        .bf-banner-name { font-size: 20px; font-weight: 900; color: #fff; text-transform: uppercase; letter-spacing: 2px; font-family: 'Baloo 2', cursive; }
        .bf-banner-sub  { font-size: 12px; color: rgba(255,255,255,0.6); margin-top: 2px; }
        ...
        .bf-title {
          font-size: 18px; font-weight: 900; color: #e8650a;
          margin-bottom: 10px;
        ...
        .bf-desc-box {
          ...
          font-size: 13px; color: #e8650a; line-height: 1.5;
        }
        .bf-desc-box strong { color: #1a1a1a; }

        .bf-session-notice {
          background: rgba(255,165,0,0.1); border: 1px solid rgba(255,165,0,0.3);
          border-radius: 8px; padding: 8px 12px; margin-bottom: 10px;
          font-size: 12px; color: #d97706; font-weight: 600; line-height: 1.5;
        }
        .bf-session-notice strong { color: #1a1a1a; }

        .bf-fg   { margin-bottom: 14px; }
        .bf-label { font-size: 11px; color: #e8650a; font-weight: 800; text-transform: uppercase; letter-spacing: 1.5px; display: block; margin-bottom: 7px; }

        .bf-input {
          width: 100%; background: #fff8f0;
          border: 1.5px solid #f5c99a; border-radius: 10px;
          padding: 11px 14px; color: #1a1a1a; font-size: 16px;
          outline: none; transition: border-color 0.2s, box-shadow 0.2s;
          box-sizing: border-box;
        }
        .bf-input:focus { border-color: #e8650a; box-shadow: 0 0 8px rgba(232,101,10,0.2); }
        ...
        .bf-chip {
          ...
          font-size: 13px; cursor: pointer; font-weight: 700; color: #e8650a;
          transition: all 0.15s;
        }
        .bf-chip:hover { background: #fff0e0; border-color: #e8650a; }
        .bf-chip.active { background: linear-gradient(135deg,#e8650a,#f59420); color: #fff; border-color: #e8650a; }

        .bf-infobox {
          background: #fff8f0; border: 1px solid #f5c99a;
          border-radius: 10px; padding: 9px 14px; margin-bottom: 12px;
          font-size: 13px; color: #e8650a;
        }
        .bf-infobox strong { color: #1a1a1a; font-size: 14px; }
        ...
        .bf-nchip:hover { border-color: #e8650a; color: #e8650a; }
        .bf-nchip.active { background: linear-gradient(135deg,#e8650a,#f59420); color: #fff; border-color: #e8650a; box-shadow: 0 0 8px rgba(232,101,10,0.3); }
        ...
        .bf-jodi-scroll::-webkit-scrollbar-thumb { background: #f5c99a; border-radius: 3px; }
        .bf-jodi-grid { display: grid; grid-template-columns: repeat(5,1fr); }
        .bf-jchip {
          padding: 10px 4px; text-align: center;
          font-size: 12px; font-weight: 700; cursor: pointer; color: #1a1a1a;
          border-right: 1px solid #e8e0d4; border-bottom: 1px solid #e8e0d4;
          transition: all 0.12s;
        }
        .bf-jchip:hover { background: #fff8f0; color: #e8650a; }
        .bf-jchip.active { background: linear-gradient(135deg,#e8650a,#f59420); color: #fff; }
        ...
        .bf-pana-grid::-webkit-scrollbar-thumb { background: #f5c99a; border-radius: 3px; }
        .bf-pchip {
          background: #fff; border: 1.5px solid #e8e0d4;
          border-radius: 8px; padding: 8px 4px;
          text-align: center; font-size: 12px; font-weight: 700;
          cursor: pointer; color: #1a1a1a; transition: all 0.12s;
        }
        .bf-pchip:hover { border-color: #e8650a; color: #e8650a; }
        .bf-pchip.active { background: linear-gradient(135deg,#e8650a,#f59420); color: #fff; border-color: #e8650a; }

        .bf-session-row { display: flex; gap: 10px; }
        .bf-session-btn {
          flex: 1; text-align: center; padding: 11px 0;
          font-size: 13px; font-weight: 800; cursor: pointer;
          border-radius: 10px; background: #fff; color: #888;
          border: 1.5px solid #e8e0d4; transition: all 0.15s; letter-spacing: 1px;
        }
        .bf-session-btn:hover { border-color: #e8650a; color: #e8650a; }
        .bf-session-btn.active { background: linear-gradient(135deg,#e8650a,#f59420); color: #fff; border-color: #e8650a; }
        .bf-session-btn.disabled { opacity: 0.4; cursor: not-allowed; }
        .bf-session-btn.disabled:hover { border-color: #e8e0d4; color: #888; }

        .bf-add-btn {
          width: 100%; background: #fff8f0; color: #e8650a;
          border: 1.5px dashed #f5c99a; border-radius: 10px;
          padding: 11px; font-weight: 700; font-size: 14px;
          cursor: pointer; margin-bottom: 14px; transition: all 0.15s;
        }
        .bf-add-btn:hover { background: #fff0e0; border-color: #e8650a; }

        .bf-bulk-table-wrap { overflow-x: auto; margin-bottom: 8px; border: 1.5px solid #e8e0d4; border-radius: 10px; }
        .bf-table { width: 100%; border-collapse: collapse; font-size: 13px; }
        .bf-table th { background: #fff8f0; color: #e8650a; padding: 9px 10px; text-align: left; font-weight: 800; letter-spacing: 1px; font-size: 11px; }
        .bf-table td { padding: 9px 10px; border-bottom: 1px solid #f0ebe0; color: #1a1a1a; }
        .bf-table tr:last-child td { border-bottom: none; }
        .bf-del { background: rgba(220,38,38,0.08); color: #dc2626; border: 1px solid rgba(220,38,38,0.3); border-radius: 5px; padding: 3px 8px; font-size: 11px; cursor: pointer; font-weight: 700; transition: all 0.15s; }
        .bf-del:hover { background: #dc2626; color: #fff; }
        ...
        .bf-total-row span   { font-size: 13px; color: #e8650a; font-weight: 600; }
        .bf-total-row strong { font-size: 16px; color: #1a1a1a; font-weight: 900; }
        ...
        .bf-place-btn:hover:not(:disabled) { transform: translateY(-2px); box-shadow: 0 8px 24px rgba(232,101,10,0.5); }
