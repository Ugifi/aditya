...
export default function GameTypePage({ game, onSelect }) {
      ...
      {game && (
        <div style={{ textAlign: 'center', marginBottom: '25px' }}>
          <div style={{
            ...
            color: '#e8650a', textTransform: 'uppercase', letterSpacing: 3,
        ...
        {activeGameTypes.map((gt, i) => (
          ...
          >
            ...
            <div style={{
              ...
              background: 'linear-gradient(90deg, transparent 30%, rgba(232,101,10,0.3) 50%, transparent 70%)',
            ...
            <div className="gt-icon-wrap" style={{
              ...
              background: '#fff8f0', border: '1.5px solid #f5c99a',

              display: 'flex', alignItems: 'center', justifyContent: 'center',
              boxShadow: '0 0 10px rgba(232,101,10,0.15)', position: 'relative',
            ...
            <div className="gt-label" style={{
              fontSize: '18px', fontWeight: 800, color: '#e8650a',
  ...
  50% { transform: translateY(-3px); }
        ...
        .gt-icon-wrap svg { width: 30px; height: 30px; fill: #e8650a; }
        @keyframes fadeInUp {
