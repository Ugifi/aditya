...
export const api = {
  ...
  updateProfile: (data) =>
    fetch(`${API_URL}/auth/update-profile`, {
      method: 'POST', headers: getMultipartHeaders(), body: data
    }).then(r => r.json()),
  ...
  // ── GAMES ─────────────────────────────────────────────────────
  getGames: (category = null) =>
    fetch(`${API_URL}/games${category ? `?category=${category}` : ''}`, { headers: getHeaders() }).then(r => r.json()),
  ...
  // ── REFERRAL ──────────────────────────────────────────────────
  referralInfo: () =>
    fetch(`${API_URL}/auth/referral-info`, { headers: getHeaders() }).then(r => r.json()),
